...
public class Reallyboll_marimo extends JFrame/*여기있는 이미지를 프레임에 그려줄거임.*/ implements ActionListener, MouseListener{
	...
	private ImageIcon rb = new ImageIcon(Reallyboll_marimo.class.getResource("../img/icon_reallyboll.png"));
	...
	JPanel sun_panel;
	JButton btn, btn2, btn3, btn4, sun, real_b;
	...
	public void homeframe() {
		...
		sun.setBackground(new Color(255, 255, 213)); // 달
...
*/
	...
	void Moveball() {
		...
		while(!(s_x+r2> 750 || s_x+r2< 0 ||s_y+r2> 1024|| s_y+r2< 0)||clickBall) {
		    s_x += r2;
		    s_y += r;
		    if(s_x+r2> 750 || s_x+r2< 0 ||s_y+r2> 1024|| s_y+r2< 0)clickBall=false;
		}*/
	}
	@Override
