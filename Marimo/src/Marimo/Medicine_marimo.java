...
public class Medicine_marimo extends JFrame/* 여기있는 이미지를 프레임에 그려줄거임. */ implements ActionListener, MouseListener {
	...
	public Medicine_marimo() {
		...
		btn.setBackground(new Color(245, 161, 163)); // 축구공
		btn2.setBackground(new Color(245, 161, 163)); // 약
		btn3.setBackground(new Color(245, 161, 163)); // 냉장고
		btn4.setBackground(new Color(245, 161, 163)); // 샤워
	...
	public void JOptionPaneEx() {
		sel = -1;
		sel = JOptionPane.showOptionDialog(this, null, "마리모에게 줄 약", JOptionPane.PLAIN_MESSAGE,
