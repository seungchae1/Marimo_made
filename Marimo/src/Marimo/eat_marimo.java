...
public class eat_marimo extends JFrame/* 여기있는 이미지를 프레임에 그려줄거임. */ implements ActionListener, MouseListener {
	private Image background = new ImageIcon(Shower_marimo.class.getResource("../img/background_.png")).getImage();// 배경이미지
	...
	public eat_marimo() {
		...
		user_panel.setBackground(new Color(233, 225, 255, 255));
		...
		main_panel.setBackground(new Color(233, 225, 255, 255));
	...
	public void JOptionPaneEx() {
		sel = -1;
		sel = JOptionPane.showOptionDialog(this, null, "마리모에게 줄 음식", JOptionPane.PLAIN_MESSAGE,
